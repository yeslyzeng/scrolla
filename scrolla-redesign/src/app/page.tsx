      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div id="features" className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Smart Notes */}
            <a href="/features/smart-notes" className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-lg transition-all group">
            ...
            {/* Visual Search */}
            <a href="/features/visual-search" className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-lg transition-all group">
            ...
            {/* Knowledge Quest */}
            <a href="/features/knowledge-quest" className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-lg transition-all group">
            ...
            {/* AI Tutor Chat */}
            <a href="/features/ai-tutor" className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-lg transition-all group">
